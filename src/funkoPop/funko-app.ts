...
yargs(hideBin(process.argv))
    .command('addUser', 'Permite añadir un usuario', {
        user: {
        ...
        try {
            ...
            log(chalk.green(`En usuario ${argv.user} ha sido añadido correctamente a la base.\n`))
        } catch(error) {
            log(chalk.red(error + "\n"))
        }
    })
    .command('deleteUser', 'Elimina un usuario', {
        user: {
            description: 'Nombre del usuario',
            type: 'string',
            demandOption: true
        ...
        try {
            ...
            log(chalk.green(`En usuario ${argv.user} ha sido eliminado correctamente a la base.\n`))
        } catch(error) {
            log(chalk.red(error + "\n"))
        }
    })
    ...
    .command('addFunko', 'Añade un funko', {
        user: {
        ...
        try {
            ...
            log(chalk.green("El funko ha sido correctamente a la coleccicón del usuario " + argv.user + ".\n"))
        } catch (error) {
            log(chalk.red(error + "\n"))
        }
    })
    .command('modFunko', 'Modifica un funko', {
        user: {
            description: 'Usuario del Funko',
            type: 'string',
            demandOption: true
        ...
        try {
            ...
            log(chalk.green("El funko del usuario " + argv.user + " ha sido modificado.\n"))
        } catch (error) {
            log(chalk.red(error + "\n"))
        }
    })
    .command('deleteFunko', 'Elimina un funko', {
        user: {
            description: 'Usuario del Funko',
            type: 'string',
            demandOption: true
        ...
        try {
            ...
            log(chalk.green("El funko de id " + argv.id + " del usuario " + argv.user + " ha sido eliminado.\n"))
        } catch (error) {
            log(chalk.red(error + "\n"))
        }
    })
    .command('readFunko', 'Lee un funko', {
        user: {
            description: 'Usuario del Funko',
            type: 'string',
            demandOption: true
    ...
    .command('listFunko', 'Lista todos los funkos de un usuario', {
        user: {
            description: 'Usuario del Funko',
            type: 'string',
            demandOption: true
