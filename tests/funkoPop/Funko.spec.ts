...
describe("Test de instanciación y métodos", () => {
  const funko1 = new Funko(1,"Goku", "El legendario supersaiyan", Tipos.Pop , Generos.Animacion,"Dragon Ball", 7, false, undefined, 13.99)
  const funko2 = new Funko(2,"Androide 16", "Androide del Doctor Gero", Tipos.Pop , Generos.Animacion,"Dragon Ball", 12, false, "Mueve la cabeza", 17.99)
  ...
  it("Existen un método para imprimir el funko", () => {
    expect(funko1.print()).to.be.eql("ID = 1\nNombre = Goku\nDescripción = El legendario supersaiyan\nTipo = Pop!\nGénero = Animacion\nFranquicia = Dragon Ball\nNúmero de colección = 7\n¿Exlusivo? = false\nValor = 13.99");
    expect(new Funko(1,"Goku", "El legendario supersaiyan", Tipos.Pop , Generos.Animacion,"Dragon Ball", 7, false, undefined, 17.99)
      .print()).to.be.eql("ID = 1\nNombre = Goku\nDescripción = El legendario supersaiyan\nTipo = Pop!\nGénero = Animacion\nFranquicia = Dragon Ball\nNúmero de colección = 7\n¿Exlusivo? = false\nValor = 17.99");
    expect(new Funko(1,"Goku", "El legendario supersaiyan", Tipos.Pop , Generos.Animacion,"Dragon Ball", 7, false, undefined, 34.99)
      .print()).to.be.eql("ID = 1\nNombre = Goku\nDescripción = El legendario supersaiyan\nTipo = Pop!\nGénero = Animacion\nFranquicia = Dragon Ball\nNúmero de colección = 7\n¿Exlusivo? = false\nValor = 34.99");
    expect(new Funko(1,"Goku", "El legendario supersaiyan", Tipos.Pop , Generos.Animacion,"Dragon Ball", 7, false, "De Oro", 70.99)
...
describe("Test frente a errores de Funko", () => {
  ...
  it("Se esperan errores cuando se pasan un ID erroneo al constructor o a traves del setter", () => {
    expect(() => new Funko(-2,"Goku", "El legendario supersaiyan", Tipos.Pop , Generos.Animacion,"Dragon Ball", 7, false, undefined, 1399)).to.throw();
  ...
  it("Se esperan errores cuando se pasan un nombre erroneo al constructor o a traves del setter", () => {
    expect(() => new Funko(2, errorVar, "El legendario supersaiyan", Tipos.Pop , Generos.Animacion,"Dragon Ball", 7, false, undefined, 1399)).to.throw();
  ...
  it("Se esperan errores cuando se pasan una descripcion erronea al constructor o a traves del setter", () => {
    expect(() => new Funko(2,"Goku", errorVar, Tipos.Pop , Generos.Animacion,"Dragon Ball", 7, false, undefined, 1399)).to.throw();
  ...
  it("Se esperan errores cuando se pasan un tipo erroneo al constructor o a traves del setter", () => {
    expect(() => new Funko(2,"Goku", "El legendario supersaiyan", errorVar , Generos.Animacion,"Dragon Ball", 7, false, undefined, 1399)).to.throw();
  ...
  it("Se esperan errores cuando se pasan un género erroneo al constructor o a traves del setter", () => {
    expect(() => new Funko(2,"Goku", "El legendario supersaiyan", Tipos.Pop , errorVar,"Dragon Ball", 7, false, undefined, 1399)).to.throw();
  ...
  it("Se esperan errores cuando se pasan una franquicia erronea al constructor o a traves del setter", () => {
    expect(() => new Funko(2,"Goku", "El legendario supersaiyan", Tipos.Pop , Generos.Animacion, errorVar, 7, false, undefined, 1399)).to.throw();
  ...
  it("Se esperan errores cuando se pasan un número erroneo al constructor o a traves del setter", () => {
    expect(() => new Funko(2,"Goku", "El legendario supersaiyan", Tipos.Pop , Generos.Animacion,"Dragon Ball", 7.3, false, undefined, 1399)).to.throw();
  ...
  it("Se esperan errores cuando se pasan una condición de exclusividad erronea al constructor o a traves del setter", () => {
    expect(() => new Funko(2,"Goku", "El legendario supersaiyan", Tipos.Pop , Generos.Animacion,"Dragon Ball", 7, errorVar, undefined, 1399)).to.throw();
  ...
  it("Se esperan errores cuando se pasan un valor erroneo al constructor o a traves del setter", () => {
    expect(() => new Funko(2,"Goku", "El legendario supersaiyan", Tipos.Pop , Generos.Animacion,"Dragon Ball", 7, false, undefined, -7.86)).to.throw();
